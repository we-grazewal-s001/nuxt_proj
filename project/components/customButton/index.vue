  ...
  <button data-testId='button' :aria-label="props.label" :aria-disabled="props.disabled || props.loading"
    ...
    <span v-else>
      ...
      <span :class="iconAlignment">
        ...
        <Icon data-testid="buttonIcon" id="iconright" v-if="props.icon" :name="props.icon" :size="props.iconSize"
          :color="`${!props.text && !props.outlined && !props.plain && !props.iconColor ? 'white' : (props.iconColor
