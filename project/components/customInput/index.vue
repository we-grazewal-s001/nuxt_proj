<template>
  <div class="flex max-sm:flex-col gap-2 items-baseline">
    ...
    <div class="flex-col flex">
      <input :name="props.name" :type="props.type" :required="props.required" class=" border-2 border-gray-300 max-w-[360px] min-w-[240px] rounded-sm px-2 py-1 outline-gray-400 " :placeholder="props.placeholder" v-model="model"/>
